...
-- 
CREATE OR REPLACE VIEW TS_INVALID_CONTENTTYPEID AS
...
-- 
CREATE OR REPLACE VIEW TS_INVALID_WORKFLOWAPPID AS
...
--
CREATE OR REPLACE VIEW TS_MULTIPLE_PARENT_NAVONS AS 
	...
	GROUP BY REL1.DEPENDENT_ID,CS.CONTENTTYPEID,CS.COMMUNITYID
	-- FILTER ON COUNT > 1
...
--
CREATE OR REPLACE VIEW TS_NON_PUB_LANDING_PAGE AS 
...
-- 
CREATE OR REPLACE VIEW TS_ORPHANED_DEP_ITEMS AS 
	...
	--
		...
		--
		CREATE OR REPLACE VIEW TS_ORPHANED_DEP_ITEMS_COM AS
		...
		--
		CREATE OR REPLACE VIEW TS_ORPHANED_DEP_ITEMS_CT AS 
		...
		--
		CREATE OR REPLACE VIEW TS_ORPHANED_DEP_ITEMS_WF AS
...
--
CREATE OR REPLACE VIEW TS_ORPHANED_DEP_NAVONS AS 
...
--
CREATE OR REPLACE VIEW TS_ORPHANED_DEP_PUB_ITEMS AS 
	...
	--
		...
		--
		CREATE OR REPLACE VIEW TS_ORPHANED_DEP_PUB_ITEMS_COM AS
		...
		--
		CREATE OR REPLACE VIEW TS_ORPHANED_DEP_PUB_ITEMS_CT AS
		...
		--
		CREATE OR REPLACE VIEW TS_ORPHANED_DEP_PUB_ITEMS_WF AS
...
-- TS_ORPHANED_FOLDERS
--
CREATE OR REPLACE VIEW TS_ORPHANED_FOLDERS AS 
...
-- TS_ORPHANED_ITEMS
--
CREATE OR REPLACE VIEW TS_ORPHANED_ITEMS AS 
	...
	--
		...
		--
		CREATE OR REPLACE VIEW TS_ORPHANED_ITEMS_COM AS 
		...
		--
		CREATE OR REPLACE VIEW TS_ORPHANED_ITEMS_CT AS 
		...
		--
		CREATE OR REPLACE VIEW TS_ORPHANED_ITEMS_WF AS 
...
-- TS_ORPHANED_NAVONS
--
CREATE OR REPLACE VIEW TS_ORPHANED_NAVONS AS 
...
--
CREATE OR REPLACE VIEW TS_ORPHANED_PUB_ITEMS AS 
	...
	--
		...
		--
		CREATE OR REPLACE VIEW TS_ORPHANED_PUB_ITEMS_COM AS
		...
		--
		CREATE OR REPLACE VIEW TS_ORPHANED_PUB_ITEMS_CT AS
		...
		--
		CREATE OR REPLACE VIEW TS_ORPHANED_PUB_ITEMS_WF AS
...
--
CREATE OR REPLACE VIEW TS_PUB_NAVONS_NO_LANDING_PAGE AS 
...
--
CREATE OR REPLACE VIEW TS_RXPUBDOCS_NO_FILENAME AS
	SELECT 
		PD.PUBSTATUSID,
		PD.CONTENTID,
		PD.VARIANTID,
...
--
CREATE OR REPLACE VIEW TS_RXPUBDOCS_NO_FILENAME_ORPH AS
	SELECT 
		PD.PUBSTATUSID,
		PD.CONTENTID,
		PD.VARIANTID,
...
--
CREATE OR REPLACE VIEW TS_SHAREDBINARY_NO_FILENAME AS
...
--
CREATE OR REPLACE VIEW TS_SHAREDIMAGE_NO_FILENAME AS
