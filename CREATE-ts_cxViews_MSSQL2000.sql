...
-- 
IF  EXISTS (SELECT * FROM sysobjects WHERE type='V' AND name='TS_INVALID_CONTENTTYPEID')
...
-- 
IF  EXISTS (SELECT * FROM sysobjects WHERE type='V' AND name='TS_INVALID_WORKFLOWAPPID')
...
--
IF  EXISTS (SELECT * FROM sysobjects WHERE type='V' AND name='TS_MULTIPLE_PARENT_NAVONS')
...
--
IF  EXISTS (SELECT * FROM sysobjects WHERE type='V' AND name='TS_NON_PUB_LANDING_PAGE')
...
-- 
IF  EXISTS (SELECT * FROM sysobjects WHERE type='V' AND name='TS_ORPHANED_DEP_ITEMS')
...
GO
	...
	--
		...
		--
		IF  EXISTS (SELECT * FROM sysobjects WHERE type='V' AND name='TS_ORPHANED_DEP_ITEMS_COM')
		...
		--
		IF  EXISTS (SELECT * FROM sysobjects WHERE type='V' AND name='TS_ORPHANED_DEP_ITEMS_CT')
		...
		--
		IF  EXISTS (SELECT * FROM sysobjects WHERE type='V' AND name='TS_ORPHANED_DEP_ITEMS_WF')
...
--
IF  EXISTS (SELECT * FROM sysobjects WHERE type='V' AND name='TS_ORPHANED_DEP_NAVONS')
...
--
IF  EXISTS (SELECT * FROM sysobjects WHERE type='V' AND name='TS_ORPHANED_DEP_PUB_ITEMS')
...
GO
	...
	--
		...
		--
		IF  EXISTS (SELECT * FROM sysobjects WHERE type='V' AND name='TS_ORPHANED_DEP_PUB_ITEMS_COM')
		...
		--
		IF  EXISTS (SELECT * FROM sysobjects WHERE type='V' AND name='TS_ORPHANED_DEP_PUB_ITEMS_CT')
		...
		--
		IF  EXISTS (SELECT * FROM sysobjects WHERE type='V' AND name='TS_ORPHANED_DEP_PUB_ITEMS_WF')
...
-- TS_ORPHANED_FOLDERS
--
IF  EXISTS (SELECT * FROM sysobjects WHERE type='V' AND name='TS_ORPHANED_FOLDERS')
...
-- TS_ORPHANED_ITEMS
--
IF  EXISTS (SELECT * FROM sysobjects WHERE type='V' AND name='TS_ORPHANED_ITEMS')
...
GO
	...
	--
		...
		--
		IF  EXISTS (SELECT * FROM sysobjects WHERE type='V' AND name='TS_ORPHANED_ITEMS_COM')
		...
		--
		IF  EXISTS (SELECT * FROM sysobjects WHERE type='V' AND name='TS_ORPHANED_ITEMS_CT')
		...
		--
		IF  EXISTS (SELECT * FROM sysobjects WHERE type='V' AND name='TS_ORPHANED_ITEMS_WF')
...
-- TS_ORPHANED_NAVONS
--
IF  EXISTS (SELECT * FROM sysobjects WHERE type='V' AND name='TS_ORPHANED_NAVONS')
...
--
IF  EXISTS (SELECT * FROM sysobjects WHERE type='V' AND name='TS_ORPHANED_PUB_ITEMS')
...
GO
	...
	--
		...
		--
		IF  EXISTS (SELECT * FROM sysobjects WHERE type='V' AND name='TS_ORPHANED_PUB_ITEMS_COM')
		...
		--
		IF  EXISTS (SELECT * FROM sysobjects WHERE type='V' AND name='TS_ORPHANED_PUB_ITEMS_CT')
		...
		--
		IF  EXISTS (SELECT * FROM sysobjects WHERE type='V' AND name='TS_ORPHANED_PUB_ITEMS_WF')
...
--
IF  EXISTS (SELECT * FROM sysobjects WHERE type='V' AND name='TS_PUB_NAVONS_NO_LANDING_PAGE')
...
--
IF  EXISTS (SELECT * FROM sysobjects WHERE type='V' AND name='TS_RXPUBDOCS_NO_FILENAME')
...
--
IF  EXISTS (SELECT * FROM sysobjects WHERE type='V' AND name='TS_RXPUBDOCS_NO_FILENAME_ORPH')
...
--
IF  EXISTS (SELECT * FROM sysobjects WHERE type='V' AND name='TS_SHAREDBINARY_NO_FILENAME')
...
--
IF  EXISTS (SELECT * FROM sysobjects WHERE type='V' AND name='TS_SHAREDIMAGE_NO_FILENAME')
